...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/uycn3p.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'ybawaskar@slc')    # Owner UPI ID for payments
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002585601614')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002585601614')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/howtoopennlinks/26")   # Tutorial link for verification
...
TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "600")) # Time gap for two-step verification in seconds (default: 20 minutes)
